...
@section('content')
    <div class="container mx-auto p-4">
        ...
        <section class="rounded-max bg-white dark:bg-gray-900">
        ...
        <div class="mt-5"></div>
        <section class="py-10 px-10 rounded-max bg-white dark:bg-gray-900">
            <h2 class="text-dark text-center mb-3.5 text-2xl font-bold sm:text-4xl xl:text-heading-3">Browse</h2>
            <p class="text-sm text-gray-600 text-center">Lorem ipsum dolor sit amet.</p>
            <button type="button"
                class="mx-auto text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Light</button>
        </section>
    </div>
@endsection
